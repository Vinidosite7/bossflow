...
const compareRows = [
  ...
  { label: 'Histórico financeiro',  cols: ['30 dias',    'Completo', 'Completo',   'Completo'  ] },
  ...
  const plans: PlanDef[] = useMemo(() => [
    {
      ...
      features: [
        ...
        { text: 'Histórico: últimos 30 dias', available: true, badge: 'limite' },
        ...
        { text: 'Estagiária Bia', available: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Estagiária Bia', available: true, badge: 'novo' },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Estagiária Bia', available: true }, { text: 'Notificações inteligentes', available: true, badge: 'novo' },
  ...
  const FEATURE_SECTIONS = [
    {
      ...
      accent: T.purple,
      items: [
        { icon: <Bot size={16} />, title: 'Estagiária Bia', desc: 'Categorização automática e insights do seu caixa.' },
