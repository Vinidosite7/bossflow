export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex" style={{ background: '#080810', fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* LEFT - Visual — hidden on mobile, flex on desktop */}
      <div className="hidden lg:flex flex-col" style={{
        width: '52%', position: 'relative', overflow: 'hidden',
        background: '#07070e', borderRight: '1px solid rgba(255,255,255,0.05)',
        padding: '48px 56px',
      }}>
        ...
        <div style={{ position: 'absolute', bottom: 0, right: 0, width: 400, height: 400, pointerEvents: 'none',
          background: 'radial-gradient(circle at 80% 80%, rgba(52,211,153,0.08) 0%, transparent 60%)' }} />
        <div style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 32, position: 'relative', zIndex: 1 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 15, color: '#3a3a5c', lineHeight: 1.65, maxWidth: 310 }}>
          ...
          <div style={{ maxWidth: 420, borderRadius: 16, overflow: 'hidden',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr',
              ...
              {[
                ...
                <div key={label} style={{ padding: '12px 14px',
                  ...
                  <p style={{ fontSize: 14, fontWeight: 700, color, marginBottom: 3 }}>{value}</p>
            ...
            <div style={{ padding: '16px 16px 14px' }}>
              ...
              <p style={{ fontSize: 10, color: '#2a2a3e' }}>Faturamento — últimos 12 meses</p>
            </div>
            ...
            <div style={{ display: 'flex', gap: 10, padding: '0 16px 16px' }}>
              {[
                ...
                <div key={label} style={{ flex: 1, padding: '10px 10px', borderRadius: 10,
                  background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}>
                  <p style={{ fontSize: 9, color: '#2a2a3e', marginBottom: 4 }}>{label}</p>
        ...
        <p style={{ fontSize: 11, color: '#1e1e2e', position: 'relative', zIndex: 1 }}>
      ...
      <div className="flex-1 flex items-center justify-center relative" style={{
        padding: '48px 32px', background: '#07070e',
      }}>
