  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 26 }}>
      ...
      <div>
        ...
        <p style={{ fontSize: 14, color: '#4a4a6a', lineHeight: 1.5 }}>Entre com sua conta para acessar o painel.</p>
      </div>
      ...
      <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
          ...
          <div style={wrap('password')}>
            ...
            <input type={showPassword ? 'text' : 'password'} placeholder="••••••••" value={password}
              onChange={e => setPassword(e.target.value)} required style={base}
        ...
        <motion.button type="submit" disabled={loading}
          ...
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
            ...
            transition: 'all 0.2s' }}>
          {loading ? <Loader2 size={15} className="animate-spin" /> : <><span>Entrar</span><ArrowRight size={15} /></>}
        </motion.button>
      </form>
