...
import {
  ...
  Eye, Pencil, Settings, Loader2, Link2,
} from 'lucide-react'
    ...
    >
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 0 60px rgba(0,0,0,0.7), 0 0 0 1px rgba(124,110,247,0.06)',
        }}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold" style={{ color: '#dcdcf0', fontFamily: 'Syne, sans-serif' }}>
              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-bold uppercase tracking-widest"
                    style={{ color: '#4a4a6a', fontFamily: 'Syne, sans-serif' }}>
                    Email do convidado
                  </label>
                  <input
                    type="email"
                    ...
                    style={{
                      ...
                      border: `1px solid ${error ? 'rgba(248,113,113,0.35)' : 'rgba(255,255,255,0.07)'}`,
                      color: '#dcdcf0', fontSize: 14, outline: 'none', boxSizing: 'border-box',
                      fontFamily: 'DM Sans, sans-serif',
                      transition: 'border-color 0.15s',
                    }}
                    onFocus={e => e.target.style.borderColor = 'rgba(124,110,247,0.4)'}
                    onBlur={e => e.target.style.borderColor = error ? 'rgba(248,113,113,0.35)' : 'rgba(255,255,255,0.07)'}
                  />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex flex-col gap-2">
                    {ROLES.map(r => (
                      <motion.button
                        key={r.value} whileTap={{ scale: 0.99 }}
                        onClick={() => setRole(r.value)}
                        style={{
                          display: 'flex', alignItems: 'center', gap: 12,
                          padding: '11px 13px', borderRadius: 12, cursor: 'pointer',
                          background: role === r.value ? r.bg : 'rgba(255,255,255,0.02)',
                          border: `1px solid ${role === r.value ? r.border : 'rgba(255,255,255,0.055)'}`,
                          transition: 'all 0.15s', textAlign: 'left',
                        }}
                      >
                        <div style={{
                          width: 32, height: 32, borderRadius: 9, flexShrink: 0,
                          background: role === r.value ? r.bg : 'rgba(255,255,255,0.03)',
                          border: `1px solid ${role === r.value ? r.border : 'rgba(255,255,255,0.055)'}`,
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-semibold"
                            style={{ color: role === r.value ? r.color : '#b0b0cc', fontFamily: 'DM Sans, sans-serif' }}>
                            {r.label}
                          </p>
                ...
                <button
                  ...
                  style={{ color: '#4a4a6a', background: 'none', border: 'none', cursor: 'pointer', padding: 0, transition: 'color 0.15s' }}
                  ...
                  {showPerms && (
                    ...
                    >
                      <div style={{
                        ...
                        <p className="text-xs font-semibold mb-2" style={{ color: selectedRole.color, fontFamily: 'Syne, sans-serif' }}>
                          {selectedRole.label} tem acesso a:
                        </p>
                        <div className="flex flex-wrap gap-1.5">
                          {PERMISSIONS_INFO[role]?.map(p => (
                            <span key={p} className="text-xs px-2 py-0.5 rounded-full"
                              style={{ background: 'rgba(255,255,255,0.04)', color: '#6b6b8a', border: '1px solid rgba(255,255,255,0.06)' }}>
                              {p}
                            </span>
                          ))}
                        </div>
              ...
              <motion.div key="success" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
                ...
                <div className="flex flex-col items-center gap-3 py-2">
                  ...
                  <div className="text-center">
                    <p className="font-bold text-sm" style={{ color: '#dcdcf0', fontFamily: 'Syne, sans-serif' }}>
                      Link gerado com sucesso!
                    </p>
                    <p className="text-xs mt-1" style={{ color: '#4a4a6a' }}>
                      Válido por <strong style={{ color: '#fbbf24' }}>48 horas</strong>. Envie para{' '}
                ...
                <div style={{
                  ...
                  <p className="text-xs mb-1.5" style={{ color: '#4a4a6a' }}>Link de convite</p>
                  <p className="text-xs font-mono break-all" style={{ color: '#9d8fff' }}>{inviteUrl}</p>
                </div>
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: copied ? 'none' : '0 4px 24px rgba(124,110,247,0.3)',
                    transition: 'all 0.3s',
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    ...
                    color: '#4a4a6a', fontSize: 13, padding: '4px 0', transition: 'color 0.15s',
                    fontFamily: 'DM Sans, sans-serif',
                  }}
                  onMouseEnter={e => e.currentTarget.style.color = '#7c6ef7'}
                  onMouseLeave={e => e.currentTarget.style.color = '#4a4a6a'}
